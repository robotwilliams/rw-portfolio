        ...
        <div className="w-full max-w-2xl px-8 loading-container relative z-10">
          <RetroLoading
            messages={[
              ...
              '<span class="terminal-prompt">$</span> <span class="terminal-command">echo</span> <span class="terminal-string">\'Initializing system consciousness\'</span>',
              "Initializing system consciousness {{dots}}",
              ...
              '<span class="terminal-prompt">$</span> <span class="terminal-command">echo</span> <span class="terminal-string">\'System initialized successfully!\'</span>',
